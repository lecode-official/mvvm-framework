...
namespace System.Windows.Mvvm.Configuration
{
    ...
    public class ConfigContext
    {
        ...
        public virtual async Task SaveChangesAsync()
        {
            ...
            // Serializes the data
            string data = await Task.Run(() => JsonConvert.SerializeObject(this, new JsonSerializerSettings { ContractResolver = new WritablePropertiesOnlyResolver(), TypeNameHandling = TypeNameHandling.All }));
